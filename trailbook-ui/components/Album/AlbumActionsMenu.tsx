...
import { archiveAlbum, deleteAlbum, restoreAlbum } from "@/lib/trailbookApi";
...
export default function AlbumActionsMenu({
  ...
  const handleArchive = async () => {
    try {
      ...
      setError("Failed to archive album. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleRestore = async () => {
    try {
      ...
      setError("Failed to restore album. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <>
      <div className="relative">
        <button
          ...
          className="p-2 rounded-lg transition-all hover:scale-110 active:scale-95 backdrop-blur-md"
          style={{
            backgroundColor: showMenu ? "rgba(255, 255, 255, 0.9)" : "rgba(255, 255, 255, 0.8)",
            color: showMenu ? "var(--theme-accent)" : "#333",
            ...
            >
              {isArchived ? (
                ...
                >
                  ...
                  <span className="text-sm font-medium">Restore Album</span>
                </button>
              ) : (
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-sm font-medium">Archive Album</span>
                </button>
              )}
      ...
      {showArchiveConfirm && (
        ...
        >
          ...
          >
            ...
            >
              This album will be hidden from your list but remain publicly accessible. You can restore it anytime from the archive.
            </p>
            {error && (
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--theme-text-secondary)" }}
            >
              This action cannot be undone. The album and all its photos will be permanently deleted.
            </p>
            {error && (
              <p className="text-sm mb-4" style={{ color: "var(--theme-error)" }}>
                {error}
